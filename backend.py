...
def insert(nome, sobrenome, email, cpf):
    TransactionObject.insert(nome, sobrenome, email, cpf)

def view():
    return TransactionObject.view()

def search(nome="", sobrenome="", email="", cpf=""):
    return TransactionObject.search(nome, sobrenome, email, cpf)

def update(id, nome, sobrenome, email, cpf):
    TransactionObject.update(id, nome, sobrenome, email, cpf)
